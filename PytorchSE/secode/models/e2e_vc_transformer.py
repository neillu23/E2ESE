...
class Transformer(TTSInterface, torch.nn.Module):
    ...
    def __init__(self, idim, odim, args=None):
        ...
        #[ChiaYu] Add after_outs & args results to model
        self.args = args
    ...
    def forward(self, xs, ilens, ys, labels, olens, spembs=None, *args, **kwargs):
        ...
        #[ChiaYu] Add after_outs results to model
        self.after_outs=after_outs #after_outs (Tensor): Batch of outputs after postnets (B, Lmax, odim).
